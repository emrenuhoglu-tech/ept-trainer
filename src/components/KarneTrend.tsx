...
// Bağımlılıksız mini sparkline: değer dizisini küçük bir SVG polyline'a çevirir.
...
// İlerleme trendi: tekrar-borcu (düşmeli) + sağlam kavram (artmalı) — zaman içinde.
// Veri karne:trend'den; her açılışta bugünün noktası eklenir. Poker içeriğine dokunmaz.
export function KarneTrend() {
  ...
  return (
    <section className="card p-4">
      <h2 className="mb-3 font-semibold">İlerleme trendi</h2>
      <div className="space-y-3">
        <Row
          label="Tekrar borcu"
          value={last.due}
          hint="bugün tekrar bekleyen — düşmesi iyi"
          color="#f5a623"
        ...
        <Row
          label="Sağlam kavram"
          value={last.saglam}
          hint="ustalaşılan konu — artması iyi"
          color="#34d399"
      ...
      {!enough && (
        <p className="mt-3 text-[11px] text-neutral-500">
          Trend çizgisi birkaç gün çalışınca belirir — her gün bir nokta eklenir.
        </p>
      )}
    </section>
  );
