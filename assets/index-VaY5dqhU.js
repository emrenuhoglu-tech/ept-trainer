const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LessonList-C2kaEvE8.js","assets/modules-D97ODb-_.js","assets/vendor-nf7bT_Uh.js","assets/ColdOpen-DHSq5BMc.js","assets/scenarios-BBMh1vwf.js","assets/LessonPlayer-B75mzo_i.js","assets/speech-Bwk-CfD9.js","assets/DataTable-jqS1wwEx.js","assets/SlideVisual-BaGv7k3z.js","assets/RangeGrid-BztrHOOY.js","assets/Quiz-CIU8ZOAZ.js","assets/quizEngine-DNUEgwlw.js","assets/ScenarioQuiz-D5yDbbPI.js","assets/Drill-BAxbwQuN.js","assets/kavramlar-iae67Qki.js","assets/DepthContrast-DzqYqCwj.js","assets/Simulator-DWg9173k.js","assets/Progress-Bh_Cnfvs.js","assets/QuickReference-DuZX6gSm.js","assets/Sentences-Dv2L292K.js","assets/RangeAtlas-C7BCifDi.js","assets/SqueezeCard-DtE111j4.js","assets/HandClasses-D1HtttUy.js","assets/EquityIntuition-CaU_He7a.js","assets/BetTypes-Cq2349ay.js","assets/QuestionBank-DGwXS8IL.js","assets/IcmCard-gYkh6f0s.js","assets/Today-D6QDZLIO.js","assets/Yayin-DWPuzkh-.js"])))=>i.map(i=>d[i]);
var xa=Object.defineProperty;var Ta=(e,i,r)=>i in e?xa(e,i,{enumerable:!0,configurable:!0,writable:!0,value:r}):e[i]=r;var Z=(e,i,r)=>Ta(e,typeof i!="symbol"?i+"":i,r);import{r as b,a as Sa,R as oa}from"./vendor-nf7bT_Uh.js";(function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))n(l);new MutationObserver(l=>{for(const t of l)if(t.type==="childList")for(const k of t.addedNodes)k.tagName==="LINK"&&k.rel==="modulepreload"&&n(k)}).observe(document,{childList:!0,subtree:!0});function r(l){const t={};return l.integrity&&(t.integrity=l.integrity),l.referrerPolicy&&(t.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?t.credentials="include":l.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function n(l){if(l.ep)return;l.ep=!0;const t=r(l);fetch(l.href,t)}})();var ba={exports:{}},V={};/**
 * @license React
 ...
 */var Pa=b,Na=Symbol.for("react.element"),Oa=Symbol.for("react.fragment"),Ia=Object.prototype.hasOwnProperty,Ra=Pa.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,Ca={key:!0,ref:!0,__self:!0,__source:!0};function ua(e,i,r){var n,l={},t=null,k=null;r!==void 0&&(t=""+r),i.key!==void 0&&(t=""+i.key),i.ref!==void 0&&(k=i.ref);for(n in i)Ia.call(i,n)&&!Ca.hasOwnProperty(n)&&(l[n]=i[n]);if(e&&e.defaultProps)for(n in i=e.defaultProps,i)l[n]===void 0&&(l[n]=i[n]);return{$$typeof:Na,type:e,key:t,ref:k,props:l,_owner:Ra.current}}V.Fragment=Oa;V.jsx=ua;V.jsxs=ua;ba.exports=V;var a=ba.exports,H={},$=Sa;H.createRoot=$.createRoot,H.hydrateRoot=$.hydrateRoot;const Ma="modulepreload",Ja=function(e){return"/ept-trainer/"+e},W={},z=function(i,r,n){let l=Promise.resolve();if(r&&r.length>0){document.getElementsByTagName("link");const k=document.querySelector("meta[property=csp-nonce]"),d=(k==null?void 0:k.nonce)||(k==null?void 0:k.getAttribute("nonce"));l=Promise.allSettled(r.map(s=>{if(s=Ja(s),s in W)return;W[s]=!0;const o=s.endsWith(".css"),u=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${s}"]${u}`))return;const y=document.createElement("link");if(y.rel=o?"stylesheet":Ma,o||(y.as="script"),y.crossOrigin="",y.href=s,d&&y.setAttribute("nonce",d),document.head.appendChild(y),o)return new Promise((p,v)=>{y.addEventListener("load",p),y.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${s}`)))})}))}function t(k){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=k,window.dispatchEvent(d),!d.defaultPrevented)throw k}return l.then(k=>{for(const d of k||[])d.status==="rejected"&&t(d.reason);return i().catch(t)})},Qa=[{id:"S1-value-boyut",kavram:"boyut",soru_ozeti:"AK top pair kuru boardda river value boyutu",sonuc:"half",not:"Fold okuması doğru, yarım pot yerine 1/3 olmalıydı"},{id:"S2-ak-stack-call",kavram:"kök-hata",soru_ozeti:"3-bet potunda AK top pair, eşleşmiş riverda stack lead'ine call",sonuc:"wrong",not:"Pasiften agresife geçiş + eşleşmiş river = value"},{id:"S4-kjo-xr",kavram:"blof-secimi",soru_ozeti:"T94 boardda KJo gutshot ile check-raise",sonuc:"wrong",not:"Board sahipliği ≠ el sınıfı; gutshot bağlantı değil, showdown değeri blöfe çevrilmez"},{id:"S5-aa-fold-erken",kavram:"kök-hata",soru_ozeti:"T94 boardda AA'yı flop check-raise'ine fold",sonuc:"wrong",not:"Aşırı düzeltme; erken sokakta call, hikâye tamamlanınca fold"},{id:"S6-jt-60bb",kavram:"3bet-aralik",soru_ozeti:"60bb CO'da JTs vs LJ reg açılışı — cevaplanmadı",sonuc:"wrong",not:"Üç kez ertelendi; ilk seansta MUTLAKA sorulacak"}],Fe="60bb, LJ'den reg açtı, sen CO'da JTs. 3-bet mi, call mi, fold mu? Ve neden diğer ikisi değil?",M="ept:";let X=!1;function x(e,i){try{const r=localStorage.getItem(M+e);return r?JSON.parse(r):i}catch{return i}}function wa(e){try{return localStorage.getItem(M+e)}catch{return null}}function E(e,i){try{localStorage.setItem(M+e,JSON.stringify(i))}catch(r){console.warn("ept: localStorage.setItem başarısız — kayıt yapılamadı",r),X||(X=!0,typeof window<"u"&&window.dispatchEvent(new CustomEvent("ept:storage-fail")))}}function He(){const e={};for(let i=0;i<localStorage.length;i++){const r=localStorage.key(i);if(r&&r.startsWith(M))try{e[r]=JSON.parse(localStorage.getItem(r))}catch{e[r]=localStorage.getItem(r)}}return JSON.stringify(e,null,2)}function qe(e){try{const i=JSON.parse(e);let r=0;for(const[n,l]of Object.entries(i))n.startsWith(M)&&(localStorage.setItem(n,typeof l=="string"?l:JSON.stringify(l)),r++);return{ok:r>0,count:r}}catch{return{ok:!1,count:0}}}function f(e=0){const i=new Date;i.setDate(i.getDate()+e);const r=i.getFullYear(),n=String(i.getMonth()+1).padStart(2,"0"),l=String(i.getDate()).padStart(2,"0");return`${r}-${n}-${l}`}const ya=[{id:"shr",name:"Super High Roller",format:"NLH",buyin:"€100K",start:"2026-08-21",end:"2026-08-23",days:"21–23 Ağu"},{id:"main",name:"Main Event",format:"NLH",buyin:"€5.3K",start:"2026-08-22",end:"2026-08-29",days:"22–29 Ağu"},{id:"hr",name:"High Roller",format:"NLH",buyin:"€10.3K",start:"2026-08-27",end:"2026-08-29",days:"27–29 Ağu"},{id:"wsop",name:"WSOP Online ME Day 2",format:"NLH",buyin:"$5K",start:"2026-09-21",end:"2026-09-22",days:"21–22 Eyl"}];function ma(e){return ya.filter(r=>r.end>=e).sort((r,n)=>r.start.localeCompare(n.start))[0]??null}function ca(e,i){return Math.round((new Date(e+"T00:00:00").getTime()-new Date(i+"T00:00:00").getTime())/864e5)}const L="karne",La="karne:corrupt-backup";function Da(){var e;return((e=ma(f(0)))==null?void 0:e.start)??""}function R(e){const i=Da();return!i||i<=f(0)?e:e>i?i:e}function Va(e,i,r){if(e==="wrong")return R(f(1));if(e==="half")return R(f(r==="tournament_life"?1:2));const n=[3,7,14,30],l=n[Math.min(Math.max(i,1)-1,n.length-1)];return R(f(l))}function Fa(e,i){const r=new Set(i).size;return e>=3&&r>=3?"saglam":e>=2&&r>=2?"yetkin":e>=1?"asina":"gorundu"}function U(e,i){return{id:e,kavram:e,soru_ozeti:"",sonuc:"wrong",streak:0,reps:0,correctDays:[],tarih:f(0),due:f(0),mastery:"gorundu",...i}}function Ha(e){const i=String(e.kavram||e.id||"kök-hata"),r=e.correctDays;return{...U(i),...e,id:i,kavram:i,correctDays:Array.isArray(r)?r:[],reps:typeof e.reps=="number"?e.reps:0,streak:typeof e.streak=="number"?e.streak:0,due:R(String(e.due||f(0)))}}function aa(e){const i=new Map;for(const r of e){const n=String(r.kavram||"kök-hata"),l=i.get(n)||U(n);l.reps+=1,l.soru_ozeti=String(r.soru_ozeti||l.soru_ozeti),l.sonuc=r.sonuc||l.sonuc,l.not=r.not||l.not,l.tarih=String(r.tarih||l.tarih),l.due=R(String(r.due||l.due)),i.set(n,l)}return[...i.values()]}function S(){const e=wa(L);if(e!==null){let r;try{r=JSON.parse(e)}catch{r=void 0}if(Array.isArray(r)&&r.length){const n=r,l=typeof n[0].reps=="number"?n.map(Ha):aa(n);return E(L,l),l}e.trim()&&!(Array.isArray(r)&&r.length===0)&&E(La,e)}const i=aa(Qa);return E(L,i),i}function pa(e,i,r){const n=S();let l=n.find(t=>t.kavram===e);if(l||(l=U(e),n.push(l)),l.reps+=1,l.soru_ozeti=i.soru_ozeti,l.sonuc=i.sonuc,l.not=i.not??l.not,l.severity=i.severity??l.severity,l.confidence=r!=null&&r.resetConfidence?void 0:i.confidence??l.confidence,l.streak=i.sonuc==="correct"?l.streak+1:0,i.sonuc==="correct"){const t=f(0);l.correctDays.includes(t)||l.correctDays.push(t)}l.tarih=f(0),l.due=Va(i.sonuc,l.streak,l.severity),l.mastery=Fa(l.streak,l.correctDays),E(L,n),Ua()}function fa(e){pa(e.kavram,e)}function qa(e,i){const r=S().find(n=>n.id===e||n.kavram===e);r&&pa(r.kavram,{soru_ozeti:r.soru_ozeti,sonuc:i,not:r.not,severity:r.severity},{resetConfidence:!0})}const D={tournament_life:0,major:1,minor:2};function ha(){const e=f(0);return S().filter(i=>i.due<=e).sort((i,r)=>D[i.severity??"minor"]-D[r.severity??"minor"]||i.due.localeCompare(r.due))}function Ya(){return S().filter(e=>e.sonuc==="wrong"&&(e.confidence??0)>=.8).sort((e,i)=>D[e.severity??"minor"]-D[i.severity??"minor"])}function Ye(){const e=S().filter(r=>(r.confidence??0)>=.8&&r.reps>0);if(!e.length)return null;const i=e.filter(r=>r.sonuc==="correct").length;return{high:e.length,hit:i}}function Ue(){const e={gorundu:0,asina:0,yetkin:0,saglam:0};for(const i of S())e[i.mastery]++;return e}const q="karne:trend";function Ua(){const e=f(0),i=S(),r=i.filter(k=>k.due<=e).length,n=i.filter(k=>k.mastery==="saglam").length,l=x(q,[]),t=l.findIndex(k=>k.day===e);t>=0?l[t]={day:e,due:r,saglam:n}:l.push({day:e,due:r,saglam:n}),E(q,l.slice(-30))}function Ge(){return x(q,[])}function _e(){const e=x("journal",[]);if(!e.length)return"";const i=[...new Set(e.map(n=>n.day))].sort().slice(-2),r=e.filter(n=>i.includes(n.day)).slice(0,6);return r.length?`
...
`):""}function Ze(){const e=ha(),i=(e.length?e:S()).slice(0,10);return i.length?i.map(r=>{const n=r.severity==="tournament_life"?" ⚠tournament_life":"",l=(r.confidence??0)>=.8&&r.sonuc==="wrong"?" (emin-ama-yanlış)":"";return`- [${r.sonuc}${n}${l}] ${r.kavram}: ${r.soru_ozeti}${r.not?" — "+r.not:""} (due ${r.due})`}).join(`
`):"(karne boş)"}const G="progress";function J(){return x(G,{days:[],quizTotal:0,quizCorrect:0})}function F(){const e=J(),i=f(0);e.days.includes(i)||e.days.push(i),E(G,e)}function $e(e){const i=J();i.quizTotal+=1,e&&(i.quizCorrect+=1);const r=f(0);i.days.includes(r)||i.days.push(r),E(G,i)}function Ga(){const e=new Set(J().days);let i=0,r=!0;for(let n=0;n<120;n++)if(e.has(f(-n)))i++;else if(n>0&&r)r=!1;else break;return i}function We(){const e=new Set(J().days);let i=0;for(let r=1;r<=30&&!e.has(f(-r));r++)i++;return i}function Xe(){var i;const e=f(0);return ca(((i=ma(e))==null?void 0:i.start)??"2026-08-16",e)}function _a(){const e=f(0);return ya.some(i=>ca(i.start,e)<=6&&e<=i.end)}function ai(){const e=J();return{streak:Ga(),practicedToday:e.days.includes(f(0)),quizTotal:e.quizTotal,quizCorrect:e.quizCorrect,totalDays:e.days.length}}function Za({onDone:e}){const i=b.useMemo(()=>ha(),[]),[r,n]=b.useState(0),[l,t]=b.useState(!1),[k,d]=b.useState(0);if(i.length===0)return a.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[a.jsx("div",{className:"text-4xl",children:"👍"}),a.jsx("p",{className:"text-neutral-300",children:"Bugün tekrar zamanı gelen konu yok."}),a.jsx("button",{onClick:e,className:"btn-accent px-4 py-2",children:"İlerlemeye dön"})]});if(r>=i.length)return a.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[a.jsx("div",{className:"text-4xl",children:"🎉"}),a.jsxs("p",{className:"text-neutral-200",children:["Bugünlük tekrar bitti — ",k," konu."]}),a.jsx("button",{onClick:e,className:"btn-accent px-4 py-2",children:"İlerlemeye dön"})]});const s=i[r];function o(u){qa(s.id,u),F(),d(y=>y+1),t(!1),n(y=>y+1)}return a.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[a.jsxs("div",{className:"flex items-center justify-between text-sm",children:[a.jsx("button",{onClick:e,className:"text-neutral-400",children:"← İlerleme"}),a.jsxs("span",{className:"text-neutral-500",children:[r+1," / ",i.length]})]}),a.jsx("div",{className:"h-1 overflow-hidden rounded bg-surface-2",children:a.jsx("div",{className:"h-full bg-accent transition-all",style:{width:`${r/i.length*100}%`}})}),a.jsxs("div",{className:"card min-h-[180px] p-5",children:[a.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:s.kavram}),a.jsx("p",{className:"mt-2 text-lg leading-relaxed text-neutral-100",children:s.soru_ozeti}),l&&a.jsxs("div",{className:"mt-4 border-t border-surface-3 pt-3",children:[a.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"Not / doğru"}),a.jsxs("p",{className:"mt-1 text-sm text-neutral-300",children:[s.not||"—",a.jsxs("span",{className:"ml-2 text-neutral-500",children:["(son sonuç: ",s.sonuc,")"]})]})]})]}),l?a.jsxs("div",{className:"grid grid-cols-3 gap-2",children:[a.jsx("button",{onClick:()=>o("wrong"),className:"btn-ghost py-3 text-red-300",children:"✗ Bilemedim"}),a.jsx("button",{onClick:()=>o("half"),className:"btn-ghost py-3 text-accent",children:"◐ Yarım"}),a.jsx("button",{onClick:()=>o("correct"),className:"btn-ghost py-3 text-emerald-300",children:"✓ Bildim"})]}):a.jsx("button",{onClick:()=>t(!0),className:"btn-accent py-3 text-base",children:"Göster"})]})}const va=`# POKER CEP KİTABI v5
...
`;function K(e){return e.replace(/\*\*(.+?)\*\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\*(.+?)\*/g,"$1").trim()}function $a(e){const i=l=>l.trim().replace(/^\|/,"").replace(/\|$/,"").split("|").map(t=>K(t)),r=i(e[0]),n=e.slice(2).map(i);return{headers:r,rows:n}}function za(){const e=[];for(const i of va.split(`
`)){if(!i.startsWith("## ")||i.startsWith("### "))continue;const r=i.slice(3).trim().match(/^Bölüm\s+(\d+)\s*(?:[—-]\s*(.*))?$/);if(!r)continue;const n=K(r[2]||"");let l=n.split(":")[0].trim()||`Bölüm ${r[1]}`;l.length>44&&(l=l.slice(0,41).trimEnd()+"…"),e.push({n:Number(r[1]),title:n,short:l})}return e.sort((i,r)=>i.n-r.n)}function g(e){const i=va.split(`
...
`)}function ei(){const e=g("Bölüm 0"),i=[];let r=null;for(const n of e.split(`
`)){const l=n.match(/^\s*(\d+)\.\s+\*\*(.+?)\*\*\s*$/);l?(r&&i.push(r),r={n:Number(l[1]),rule:K(l[2]),context:""}):r&&n.trim()&&!n.trim().startsWith("#")&&!n.trim().startsWith("*")&&(r.context=(r.context+" "+K(n.trim())).trim())}return r&&i.push(r),i.filter(n=>n.n>=1&&n.n<=15)}function ga(e){const i=e.split(`
