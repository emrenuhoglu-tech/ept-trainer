const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/Quiz-B98rUzXd.js","assets/vendor-nf7bT_Uh.js","assets/quizEngine-YcQMbCYe.js","assets/Drill-Bq6EstFB.js","assets/kavramlar-D96rNycD.js","assets/Simulator-CPYjrfIj.js","assets/Progress-BiIBh5r8.js","assets/QuickReference-B_OK8CQu.js","assets/Sentences-ByTAk8mf.js","assets/RangeAtlas-C_V4X2mo.js","assets/EquityIntuition-hSgOIQnY.js","assets/BetTypes-DWkDXoZ5.js","assets/QuestionBank-DQbrCQrD.js","assets/IcmCard-D0BkWK5B.js"])))=>i.map(i=>d[i]);
var oa=Object.defineProperty;var da=(a,n,r)=>n in a?oa(a,n,{enumerable:!0,configurable:!0,writable:!0,value:r}):a[n]=r;var Y=(a,n,r)=>da(a,typeof n!="symbol"?n+"":n,r);import{r as c,a as ka,R as qe}from"./vendor-nf7bT_Uh.js";(function(){const n=document.createElement("link").relList;if(n&&n.supports&&n.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))i(l);new MutationObserver(l=>{for(const t of l)if(t.type==="childList")for(const s of t.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&i(s)}).observe(document,{childList:!0,subtree:!0});function r(l){const t={};return l.integrity&&(t.integrity=l.integrity),l.referrerPolicy&&(t.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?t.credentials="include":l.crossOrigin==="anonymous"?t.credentials="omit":t.credentials="same-origin",t}function i(l){if(l.ep)return;l.ep=!0;const t=r(l);fetch(l.href,t)}})();var Ye={exports:{}},ke={};/**
 * @license React
...
`;function S(a){return a.replace(/\*\*(.+?)\*\*/g,"$1").replace(/`(.+?)`/g,"$1").replace(/\*(.+?)\*/g,"$1").trim()}function Qa(a){const n=l=>l.trim().replace(/^\|/,"").replace(/\|$/,"").split("|").map(t=>S(t)),r=n(a[0]),i=a.slice(2).map(n);return{headers:r,rows:i}}function D(a){const n=Ja.split(`
...
`)}function sr(){const a=D("Bölüm 0"),n=[];let r=null;for(const i of a.split(`
`)){const l=i.match(/^\s*(\d+)\.\s+\*\*(.+?)\*\*\s*$/);l?(r&&n.push(r),r={n:Number(l[1]),rule:S(l[2]),context:""}):r&&i.trim()&&!i.trim().startsWith("#")&&!i.trim().startsWith("*")&&(r.context=(r.context+" "+S(i.trim())).trim())}return r&&n.push(r),n.filter(i=>i.n>=1&&i.n<=15)}function Ze(a){const n=a.split(`
...
`)}),r}function N(a,n){const r=Ze(a).find(i=>i.title.startsWith(n));return r?r.body:""}function Q(a){const n=a.split(`
`),r=[];for(const i of n)if(i.trim().startsWith("|"))r.push(i);else if(r.length)break;return r.length>=2?Qa(r):null}function de(a,n){const r=n?/^\s*\d+\.\s+(.*)$/:/^\s*[-*]\s+(.*)$/;return a.split(`
`).map(i=>i.match(r)).filter(i=>!!i).map(i=>S(i[1]))}function Ia(){const a=D("Bölüm 4"),r=N(a,"4.3").split(`
`),i=[];let l=null;const t=()=>{var k,m,u,f,b;if(!l)return;const s=l.buf.join(`
`);let o=Q(s),d=[];if(o)d=l.buf.filter(p=>/^\*\*[^*]*flat/i.test(p.trim())).map(p=>S(p));else{const p=(k=s.match(/VALUE:\*\*\s*(.+)/i))==null?void 0:k[1],y=(m=s.match(/BL[ÖO]F:\*\*\s*(.+)/i))==null?void 0:m[1];if(p||y){const z=((f=(u=/yaln[ıi]z\s+(BB|SB|BTN|CO)/i.exec(l.label))==null?void 0:u[1])==null?void 0:f.toUpperCase())||"BB";o={headers:["Pozisyon","VALUE","BLÖF"],rows:[[z,S(p||""),S(y||"")]]};const T=(b=s.match(/Flat:\*\*\s*(.+)/i))==null?void 0:b[1];T&&(d=[`${z} flat: ${S(T)}`])}}o&&i.push({opener:Fa(l.label),label:l.label,table:o,flats:d}),l=null};for(const s of r){const o=s.trim().match(/^\*\*(.+?açılışına karşı.*?)\*\*$/);o?(t(),l={label:o[1],buf:[]}):l&&l.buf.push(s)}return t(),i}function Fa(a){return a.split("açılışına")[0].trim().replace(/\s*\/\s*/g,"/")}function or(){const a=D("Hızlı Referans");return{decisionOrder:de(N(a,"Karar sırası"),!0),sizes:Q(N(a,"Boyutlar")),band2530:Q(N(a,"25")),postflop:Q(N(a,"Postflop")),icm:Q(N(a,"ICM")),multiway:Q(N(a,"Multiway")),tilt:Q(N(a,"Tilt")),redFlags:de(N(a,"Kırmızı bayraklar"),!1)}}function dr(){const a=D("Bölüm 10");return Ze(a).map(n=>({title:n.title,questions:de(n.body,!0)})).filter(n=>n.questions.length>0)}function w(a,n){const r=D(a),i=n?N(r,n):r;return Q(i)}function kr(){const a=w("Bölüm 5","5.1");return a?a.rows.map(n=>({position:n[0],range:n[1]})):[]}function cr(){const a=w("Bölüm 5","5.2");return a?a.rows.map(n=>({vs:n[0],range:n[1]})):[]}function ur(){const n=N(D("Bölüm 5"),"5.3").match(/geldiyse:\s*([^.]+)\./);return n?S(n[1]):""}function mr(){const a=w("Bölüm 4","4.5");if(!a)return null;const n=k=>{const m=a.rows.find(u=>u[0].toLowerCase().startsWith(k));return m?m[1]:""},r=k=>k.split(/[—;:]/)[0].trim(),i=r(n("4-bet value")),l=r(n("4-bet karışım")),t=r(n("4-bet blöf")),s=r(n("flat")),o=n("fold"),d=l?l.split(",").map(k=>`${k.trim()} (karışım)`).join(", "):"";return{value:d?`${i}, ${d}`:i,blof:t,flat:s,foldNote:o}}function br(){const a=N(D("Bölüm 4"),"4.6"),n=a.match(/VALUE:\*\*\s*(.+)/i),r=a.match(/BLÖF:\*\*\s*(.+)/i);return!n&&!r?null:{value:n?S(n[1]):"",blof:r?S(r[1]):""}}function yr(){return w("Bölüm 4","4.7")}function pr(){return w("Bölüm 14","14.1")}function fr(){const n=N(D("Bölüm 14"),"14.1").match(/\*\*Kural:\*\*\s*(.+)/);return n?S(n[1]):""}function hr(){return w("Bölüm 11","11.1")}function vr(){return w("Bölüm 6","6.2")}function gr(){return w("Bölüm 11","11.2")}function xr(){return w("Bölüm 11","11.3")}function Br(){return de(N(D("Bölüm 11"),"11.4"),!1)}function zr(){return w("Bölüm 13","13.1")}function Ar(){return w("Bölüm 15","15.2")}const Ha=[[/\bcheck-?raise\b/gi,"çek reyz"],[/\bcheck-?call\b/gi,"çek kol"],[/\bcheck-?fold\b/gi,"çek fold"],[/\bstack-?off\b/gi,"stek of"],[/\bsemi-?bluff\b/gi,"semi blaf"],[/\bbluff-?catcher\b/gi,"blaf keçır"],[/\bcoldcall\b/gi,"kold kol"],[/\bcbet\b/gi,"si bet"],[/\b5-?bet\b/gi,"beş bet"],[/\b4-?bet\b/gi,"dört bet"],[/\b3-?bet\b/gi,"üç bet"],[/(\d)\s?bb\b/gi,"$1 big blaynd"],[/\bOOP\b/g,"o o pi"],[/\bIP\b/g,"ay pi"],[/\bICM\b/g,"ay si em"],[/\bPLO\b/g,"pi el o"],[/\bNLH\b/g,"en el eyç"],[/\bBB\b/g,"big blaynd"],[/\bSB\b/g,"smol blaynd"],[/\bBTN\b/g,"batın"],[/\bUTG\b/g,"yu ti ci"],[/\bbluff\b/gi,"blaf"],[/\bvalue\b/gi,"velyu"],[/\bboard\b/gi,"bord"],[/\bflat\b/gi,"flet"],[/\bflop\b/gi,"flop"],[/\briver\b/gi,"rivır"],[/\bturn\b/gi,"törn"],[/\bcall\b/gi,"kol"],[/\braise\b/gi,"reyz"],[/\bsqueeze\b/gi,"skuiz"],[/\bgutshot\b/gi,"gatşat"],[/\brakeback\b/gi,"reykbek"],[/\bstack\b/gi,"stek"],[/\bbubble\b/gi,"babıl"],[/\bnut\b/gi,"nat"],[/\bkicker\b/gi,"kikır"],[/\brundown\b/gi,"randaun"],[/\bdangler\b/gi,"denglır"],[/\bwrap\b/gi,"rep"],[/\bstation\b/gi,"steyşın"],[/\bshowdown\b/gi,"şovdaun"],[/\bequity\b/gi,"ekvıti"]];function qa(a){let n=a;for(const[r,i]of Ha)n=n.replace(r,i);return n}class Ya{constructor(){Y(this,"supported",typeof window<"u"&&"speechSynthesis"in window);Y(this,"voice",null);this.supported&&(this.pickVoice(),window.speechSynthesis.onvoiceschanged=()=>this.pickVoice())}pickVoice(){const n=window.speechSynthesis.getVoices();this.voice=n.find(r=>r.lang==="tr-TR")||n.find(r=>r.lang.startsWith("tr"))||null}speak(n,r=1){return this.supported?(window.speechSynthesis.cancel(),new Promise(i=>{const l=new SpeechSynthesisUtterance(qa(n));l.lang="tr-TR",this.voice&&(l.voice=this.voice),l.rate=r,l.pitch=1,l.onend=()=>i(),l.onerror=()=>i(),window.speechSynthesis.speak(l)})):Promise.resolve()}stop(){this.supported&&window.speechSynthesis.cancel()}}function Le(){return localStorage.getItem("ept:tts:mode")||"hd"}function jr(a){localStorage.setItem("ept:tts:mode",a)}function Va(a){let n=5381;for(let r=0;r<a.length;r++)n=n*33^a.charCodeAt(r);return"a"+(n>>>0).toString(36)}function Xe(){return new Promise((a,n)=>{const r=indexedDB.open("ept-tts",1);r.onupgradeneeded=()=>r.result.createObjectStore("audio"),r.onsuccess=()=>a(r.result),r.onerror=()=>n(r.error)})}async function $a(a){try{const n=await Xe();return await new Promise(r=>{const i=n.transaction("audio").objectStore("audio").get(a);i.onsuccess=()=>r(i.result||null),i.onerror=()=>r(null)})}catch{return null}}async function _a(a,n){try{(await Xe()).transaction("audio","readwrite").objectStore("audio").put(n,a)}catch{}}async function Ua(a){try{const r=await fetch(`${typeof import.meta<"u"&&"/ept-trainer/"||"/"}tts/${a}.mp3`);if(!r.ok)return null;const i=await r.blob();return i.size<256||i.type&&!/audio|mpeg|octet/.test(i.type)?null:i}catch{return null}}async function ea(a){const n=Va("v1|"+a);let r=await $a(n);if(r)return r;if(r=await Ua(n),!r)try{const i=await fetch("/api/tts",{method:"POST",headers:{"content-type":"application/json"},body:JSON.stringify({text:a})});i.ok&&(r=await i.blob())}catch{}return r&&_a(n,r),r}class Wa{constructor(){Y(this,"web",new Ya);Y(this,"audio",null)}get supported(){return this.web.supported||Le()==="hd"}stopAudio(){this.audio&&(this.audio.pause(),this.audio.src="",this.audio=null)}async speak(n,r=1){if(Le()!=="hd")return this.web.speak(n,r);const i=await ea(n);if(!i)return this.web.speak(n,r);await new Promise(l=>{this.stopAudio();const t=new Audio(URL.createObjectURL(i));t.playbackRate=r,t.onended=()=>l(),t.onerror=()=>l(),this.audio=t,t.play().catch(()=>l())})}stop(){this.stopAudio(),this.web.stop()}}let fe=null;function Ga(){return fe||(fe=new Wa),fe}function Za(a){return(a.match(/[^.!?]+[.!?]*/g)||[a]).map(n=>n.trim()).filter(Boolean)}async function Xa(a,n){let r=0,i=0;const l=a.length;for(let t=0;t<a.length;t++)await ea(a[t])?r++:i++,n==null||n(t+1,l);return{ok:r,fail:i}}function en({table:a}){return e.jsx("div",{className:"overflow-x-auto rounded-xl border border-surface-3",children:e.jsxs("table",{className:"w-full text-sm",children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-surface-2 text-left text-neutral-300",children:a.headers.map((n,r)=>e.jsx("th",{className:"px-3 py-2 font-medium",children:n},r))})}),e.jsx("tbody",{children:a.rows.map((n,r)=>e.jsx("tr",{className:"border-t border-surface-3 align-top",children:n.map((i,l)=>e.jsx("td",{className:l===0?"px-3 py-2 font-semibold text-neutral-100 whitespace-nowrap":"px-3 py-2 text-neutral-300",children:i},l))},r))})]})})}const E=["A","K","Q","J","T","9","8","7","6","5","4","3","2"],K=Object.fromEntries(E.map((a,n)=>[a,n]));function an(a,n){const r=E[Math.min(a,n)],i=E[Math.max(a,n)];return a===n?`${r}${i}`:a<n?`${r}${i}s`:`${r}${i}o`}function nn(a,n){return K[a]<=K[n]?[a,n]:[n,a]}function he(a){const n=a.trim().replace(/[–—]/g,"-").replace(/\s+/g,"");if(!n)return[];const r="[AKQJT98765432]";let i=n.match(new RegExp(`^(${r})\\1\\+$`));if(i){const l=[];for(let t=0;t<=K[i[1]];t++)l.push(`${E[t]}${E[t]}`);return l}if(i=n.match(new RegExp(`^(${r})\\1-(${r})\\2$`)),i){const[l,t]=[K[i[1]],K[i[2]]],s=[];for(let o=Math.min(l,t);o<=Math.max(l,t);o++)s.push(`${E[o]}${E[o]}`);return s}if(i=n.match(new RegExp(`^(${r})\\1$`)),i)return[`${i[1]}${i[1]}`];if(i=n.match(new RegExp(`^(${r})(${r})(s|o)\\+$`)),i){const[l,t,s]=[i[1],i[2],i[3]];if(K[l]>=K[t])return null;const o=[];for(let d=K[l]+1;d<=K[t];d++)o.push(`${l}${E[d]}${s}`);return o}if(i=n.match(new RegExp(`^(${r})(${r})(s|o)-(${r})(${r})(s|o)$`)),i){const[l,t,s,o,d,k]=[i[1],i[2],i[3],i[4],i[5],i[6]];if(l!==o||s!==k)return null;const m=[];for(let u=Math.min(K[t],K[d]);u<=Math.max(K[t],K[d]);u++)m.push(`${l}${E[u]}${s}`);return m}if(i=n.match(new RegExp(`^(${r})(${r})(s|o)$`)),i){const[l,t]=nn(i[1],i[2]);return[`${l}${t}${i[3]}`]}return null}function ve(a,n){const r=new Set,i=[];if(!a)return{cells:r,notes:i};let l=a.trim();const t="[AKQJT98765432]";l=l.replace(new RegExp(`(${t}${t}[so]?)\\s*\\(\\s*kar[ıi]ş[ıi]m\\s*\\)`,"gi"),(s,o)=>{var d;return(d=he(o))==null||d.forEach(k=>n==null?void 0:n.add(k))," "}),l=l.replace(new RegExp(`\\(\\s*(${t}${t}?[so]?)\\s*kar[ıi]ş[ıi]m\\s*\\)`,"gi"),(s,o)=>{var d;return(d=he(o))==null||d.forEach(k=>n==null?void 0:n.add(k))," "}),l=l.replace(/\([^)]*\)/g," ");for(const s of l.split(",")){const o=s.trim().replace(/\.$/,"");if(!o||/^(yok|—|-)$/i.test(o))continue;const d=he(o);d?d.forEach(k=>r.add(k)):(/[a-zçğıöşü]/i.test(o)&&o.length>3||o.length>1)&&i.push(o)}return{cells:r,notes:i}}const rn={value:"bg-emerald-500 text-black font-semibold",mix:"bg-emerald-500/35 text-emerald-50 ring-1 ring-inset ring-emerald-400/70",blof:"bg-accent text-black font-semibold",flat:"bg-sky-600 text-white",fold:"bg-surface-2 text-neutral-600"};function aa({value:a,blof:n,flat:r,caption:i,compact:l,highlight:t,valueLabel:s,blofLabel:o}){const{catOf:d,notes:k}=c.useMemo(()=>{const b=new Set,p=ve(a||"",b),y=ve(n||""),z=ve(r||""),T=[...p.notes,...y.notes,...z.notes];return{catOf:B=>p.cells.has(B)?"value":b.has(B)?"mix":y.cells.has(B)?"blof":z.cells.has(B)?"flat":"fold",notes:T}},[a,n,r]),m=[];for(let b=0;b<13;b++)for(let p=0;p<13;p++){const y=an(b,p);m.push({code:y,label:E[Math.min(b,p)]+E[Math.max(b,p)],cat:d(y),pair:b===p})}const u=b=>m.some(p=>p.cat===b),f=l?"text-[7px]":"text-[9px] sm:text-[11px]";return e.jsxs("div",{children:[e.jsx("div",{className:"grid gap-[2px] rounded-lg bg-surface-3 p-[2px]",style:{gridTemplateColumns:"repeat(13, minmax(0, 1fr))"},children:m.map(b=>e.jsx("div",{title:b.code,className:"flex aspect-square items-center justify-center rounded-[3px] leading-none "+f+" "+rn[b.cat]+(t&&b.code===t?" ring-2 ring-white ring-offset-1 ring-offset-surface-3 z-10 scale-110":b.pair?" ring-1 ring-inset ring-white/25":""),children:b.label},b.code))}),e.jsxs("div",{className:"mt-2 flex flex-wrap gap-x-3 gap-y-1 text-[11px] text-neutral-300",children:[u("value")&&e.jsx(ne,{cls:"bg-emerald-500",label:s||"Value 3-bet"}),u("mix")&&e.jsx(ne,{cls:"bg-emerald-500/35 ring-1 ring-inset ring-emerald-400/70",label:"Karışım"}),u("blof")&&e.jsx(ne,{cls:"bg-accent",label:o||"Blöf 3-bet"}),u("flat")&&e.jsx(ne,{cls:"bg-sky-600",label:"Flat (call)"})]}),i&&e.jsx("p",{className:"mt-2 text-xs text-neutral-500",children:i}),k.length>0&&e.jsxs("p",{className:"mt-1 text-xs text-neutral-400",children:[e.jsx("span",{className:"text-neutral-500",children:"+ kitap notu:"})," ",k.join(", ")]})]})}function ne({cls:a,label:n}){return e.jsxs("span",{className:"inline-flex items-center gap-1.5",children:[e.jsx("span",{className:"inline-block h-3 w-3 rounded-[3px] "+a}),n]})}const ln={A:14,K:13,Q:12,J:11,T:10,9:9,8:8,7:7,6:6,5:5,4:4,3:3,2:2},De={s:"♠",h:"♥",d:"♦",c:"♣"};function tn(a){const n=a.trim().split(/[\s,]+/).map(k=>k.match(/^([AKQJT2-9])([shdc])$/i)).filter(Boolean).map(k=>({r:ln[k[1].toUpperCase()],s:k[2].toLowerCase()}));if(n.length<3)return[];const r=[],i={};for(const k of n)i[k.s]=(i[k.s]||0)+1;const[l,t]=Object.entries(i).sort((k,m)=>m[1]-k[1])[0];t>=3?r.push({label:`üç ${De[l]} — flush board`,wet:!0}):t===2?r.push({label:`iki ${De[l]} — flush draw'lı`,wet:!0}):r.push({label:"rainbow",wet:!1});const s={};for(const k of n)s[k.r]=(s[k.r]||0)+1;Object.values(s).some(k=>k>=2)&&r.push({label:"eşli",wet:!1});const o=[...new Set(n.map(k=>k.r))].sort((k,m)=>k-m),d=o[o.length-1]-o[0];return d<=4?r.push({label:"bağlantılı — kent'li",wet:!0}):d>=7&&r.push({label:"kuru",wet:!1}),r}const Je=new Set(["A","K","Q","J","T","9","8","7","6","5","4","3","2"]),Qe={s:{sym:"♠",red:!1},h:{sym:"♥",red:!0},d:{sym:"♦",red:!0},c:{sym:"♣",red:!1}},na={sm:{w:34,r:12,big:18},md:{w:46,r:15,big:26},lg:{w:64,r:20,big:38}};function xe({rank:a,suit:n,size:r="md"}){const i=Qe[n]||Qe.s,l=na[r],t=i.red?"#e5484d":"#141414";return e.jsxs("div",{className:"relative inline-flex shrink-0 flex-col items-center justify-center rounded-lg bg-white shadow-md",style:{width:l.w,height:Math.round(l.w*1.4)},children:[e.jsx("span",{className:"absolute left-1 top-0.5 font-bold leading-none",style:{fontSize:l.r,color:t},children:a}),e.jsx("span",{style:{fontSize:l.big,color:t,lineHeight:1},children:i.sym})]})}function sn({size:a="md"}){const n=na[a];return e.jsx("div",{className:"inline-flex shrink-0 items-center justify-center rounded-lg border border-surface-3 bg-surface-2 text-neutral-500",style:{width:n.w,height:Math.round(n.w*1.4),fontSize:n.r},title:"kitapta belirtilmemiş",children:"?"})}function on(a){return a.length>=3&&a[2]==="s"?["s","s"]:a.length>=3&&a[2]==="o"?["s","h"]:["s","h"]}function dn({code:a,size:n="md"}){const r=a.trim(),[i,l]=[r[0],r[1]],[t,s]=on(r),o=r[2]==="s",d=r[2]==="o";return e.jsxs("span",{className:"inline-flex items-end gap-1.5",children:[e.jsxs("span",{className:"flex gap-1",children:[e.jsx(xe,{rank:i,suit:t,size:n}),e.jsx(xe,{rank:l,suit:s,size:n})]}),(o||d)&&e.jsx("span",{className:"mb-1 rounded px-1.5 py-0.5 text-[10px] font-semibold "+(o?"bg-emerald-500/20 text-emerald-300":"bg-neutral-500/20 text-neutral-300"),children:o?"suited":"offsuit"})]})}function F({spec:a,size:n="md",label:r,texture:i}){const l=a.trim().split(/[\s,]+/).filter(Boolean),t=i?tn(a):[];return e.jsxs("div",{children:[r&&e.jsx("div",{className:"mb-1 text-xs uppercase tracking-wide text-neutral-500",children:r}),e.jsx("div",{className:"flex flex-wrap items-end gap-1.5",children:l.map((s,o)=>{if(s==="??"||s==="?")return e.jsx(sn,{size:n},o);if(s.length>=2&&Je.has(s[0])&&Je.has(s[1]))return e.jsx(dn,{code:s,size:n},o);const d=s.match(/^([AKQJT2-9])([shdc])$/i);return d?e.jsx(xe,{rank:d[1].toUpperCase(),suit:d[2].toLowerCase(),size:n},o):e.jsx("span",{className:"text-sm text-neutral-500",children:s},o)})}),t.length>0&&e.jsx("div",{className:"mt-1.5 flex flex-wrap gap-1.5",children:t.map((s,o)=>e.jsx("span",{className:"rounded-full px-2 py-0.5 text-[11px] "+(s.wet?"bg-accent-soft text-accent":"bg-surface-2 text-neutral-400"),children:s.label},o))})]})}function kn({data:a}){const[n,r]=c.useState(0),i=a.streets.slice(0,n+1).map(t=>t.add).filter(Boolean).join(" "),l=a.streets[n];return e.jsxs("div",{className:"card p-4",children:[e.jsxs("div",{className:"mb-3 flex items-center justify-between",children:[e.jsx("span",{className:"text-sm font-semibold text-neutral-100",children:"🎬 Vaka oynatıcı"}),e.jsxs("span",{className:"text-xs text-neutral-500",children:[n+1,"/",a.streets.length," · ",l.name]})]}),i?e.jsx(F,{spec:i,size:"md",label:"Board",texture:!0}):e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-600",children:"Board (preflop)"}),e.jsxs("div",{className:"mt-3 flex flex-wrap gap-4",children:[e.jsx(F,{spec:a.hero,size:"sm",label:a.heroLabel??"Sen"}),a.villain&&e.jsx(F,{spec:a.villain,size:"sm",label:a.villainLabel??"Rakip"})]}),e.jsx("p",{className:"mt-3 rounded-lg bg-surface-2 px-3 py-2 text-sm leading-relaxed text-neutral-200",children:l.note}),e.jsxs("div",{className:"mt-3 flex items-center gap-2",children:[e.jsx("button",{onClick:()=>r(t=>Math.max(0,t-1)),disabled:n===0,className:"btn-ghost px-3 py-1.5 text-sm",children:"← Geri"}),e.jsx("button",{onClick:()=>r(t=>Math.min(a.streets.length-1,t+1)),disabled:n===a.streets.length-1,className:"btn-accent px-3 py-1.5 text-sm",children:"Sonraki sokak →"})]})]})}function cn({v:a}){switch(a.kind){case"hand":return e.jsx(F,{spec:a.cards,size:a.size||"lg",label:a.label});case"board":return e.jsx(F,{spec:a.cards,size:a.size||"md",label:a.label??"Board",texture:!0});case"range":return e.jsx(aa,{value:a.value,blof:a.blof,flat:a.flat,caption:a.caption,compact:a.compact,valueLabel:a.valueLabel,blofLabel:a.blofLabel});case"replay":return e.jsx(kn,{data:a.replay})}}function un({items:a}){return!a||a.length===0?null:e.jsx("div",{className:"space-y-4",children:a.map((n,r)=>e.jsx(cn,{v:n},r))})}function mn(){const a=c.useMemo(()=>Ia(),[]),[n,r]=c.useState(0),[i,l]=c.useState(0);if(a.length===0)return e.jsx("p",{className:"text-sm text-neutral-400",children:"Aralık grupları yüklenemedi."});const t=a[n];return e.jsxs("div",{className:"space-y-3",children:[e.jsxs("div",{children:[e.jsx("div",{className:"mb-1 text-xs uppercase tracking-wide text-neutral-500",children:"Kim açtı?"}),e.jsx("div",{className:"flex flex-wrap gap-2",children:a.map((s,o)=>e.jsx("button",{onClick:()=>{r(o),l(0)},className:o===n?"btn-accent px-3 py-1.5 text-sm":"btn-ghost px-3 py-1.5 text-sm",children:s.opener},o))})]}),e.jsx("div",{className:"text-xs text-neutral-500",children:t.label}),e.jsx("div",{className:"overflow-hidden rounded-xl border border-surface-3",children:e.jsxs("table",{className:"w-full text-sm",children:[e.jsx("thead",{children:e.jsx("tr",{className:"bg-surface-2 text-left text-neutral-300",children:t.table.headers.map((s,o)=>e.jsx("th",{className:"px-3 py-2 font-medium",children:s},o))})}),e.jsx("tbody",{children:t.table.rows.map((s,o)=>{const d=o===i;return e.jsx("tr",{onClick:()=>l(d?null:o),className:"cursor-pointer border-t border-surface-3 align-top transition "+(d?"bg-accent-soft ring-1 ring-accent":"hover:bg-surface-2"),children:s.map((k,m)=>e.jsx("td",{className:m===0?"px-3 py-2 font-semibold text-neutral-100 whitespace-nowrap":"px-3 py-2 "+(d?"text-neutral-100":"text-neutral-300"),children:k},m))},o)})})]})}),e.jsx("p",{className:"text-xs text-neutral-500",children:"Kendi pozisyonuna dokun — value ve blöf aralığın 13×13 grid'de renklensin."}),i!==null&&t.table.rows[i]&&e.jsxs("div",{className:"rounded-xl border border-surface-3 bg-surface-1 p-3",children:[e.jsxs("div",{className:"mb-2 text-sm font-semibold text-neutral-100",children:[t.table.rows[i][0]," · 3-bet aralığı"]}),e.jsx(aa,{value:t.table.rows[i][1],blof:t.table.rows[i][2]})]}),t.flats.length>0&&e.jsx("ul",{className:"space-y-1 text-xs text-neutral-400",children:t.flats.map((s,o)=>e.jsxs("li",{children:["• ",s]},o))})]})}const $=Ga(),bn=[.8,1,1.25,1.5],re=999;function yn(a){var n,r;return(((n=a.bullets)==null?void 0:n.length)??0)+((r=a.visuals)!=null&&r.length?1:0)+(a.table?1:0)+(a.rangeMatrix?1:0)+(a.ruleBox?1:0)}function pn({moduleId:a,onBack:n}){var we,Oe;const r=c.useMemo(()=>va(a),[a]),[i,l]=c.useState(0),[t,s]=c.useState(!1),[o,d]=c.useState(!0),[k,m]=c.useState(1),[u,f]=c.useState(re),[b,p]=c.useState(-1),[y,z]=c.useState({i:0,n:0}),[T,L]=c.useState(()=>{const h=$e[a];return h&&!R("coldopen:done",[]).includes(a)?h:null}),B=c.useRef(!1),P=c.useRef(k),G=c.useRef(o),me=c.useRef(null);if(P.current=k,G.current=o,c.useEffect(()=>()=>{B.current=!1,$.stop()},[]),c.useEffect(()=>{if(b<0||!me.current)return;const h=me.current.querySelector('[data-active="true"]');h==null||h.scrollIntoView({block:"center",behavior:"smooth"})},[b]),!r)return e.jsxs("div",{className:"p-4",children:[e.jsx("button",{className:"btn-ghost",onClick:n,children:"← Geri"}),e.jsx("p",{className:"mt-4 text-neutral-400",children:"Modül bulunamadı."})]});if(T)return e.jsx(za,{kavram:T,onStart:()=>{const h=R("coldopen:done",[]);h.includes(a)||C("coldopen:done",[...h,a]),L(null)}});const J=r.slides,A=J[i],la=i===J.length-1;let Z=((we=A.bullets)==null?void 0:we.length)??0;const X=(Oe=A.visuals)!=null&&Oe.length?Z++:-1,be=A.table?Z++:-1,ye=A.rangeMatrix?Z++:-1,ee=A.ruleBox?Z++:-1,V=h=>h>=0&&h<u,j=h=>t&&h===b,Te=h=>{if(h!==J.length-1)return;const g=R("lessons:done",[]);g.includes(r.id)||C("lessons:done",[...g,r.id])},Ke=()=>{B.current=!1,$.stop(),s(!1),p(-1),f(re)},ta=async h=>{B.current=!0,s(!0);for(let g=h;g<J.length&&B.current;g++){l(g),Te(g);const q=Za(J[g].narration),pe=yn(J[g]);f(0),p(-1);for(let I=0;I<q.length&&B.current;I++){q[I+1]&&Xa([q[I+1]]);const Ce=pe===0?-1:Math.min(pe-1,Math.floor(I/q.length*pe));p(Ce),f(sa=>Math.max(sa,Ce+1)),z({i:I+1,n:q.length}),await $.speak(q[I],P.current)}if(f(re),p(-1),!B.current||!G.current)break}B.current=!1,s(!1),z({i:0,n:0})},Se=h=>{Ke();const g=Math.min(Math.max(h,0),J.length-1);l(g),f(re),Te(g)},ae=h=>"reveal-in transition-all duration-300 "+(t?h?"opacity-100":"opacity-40":"opacity-100");return e.jsxs("div",{className:"flex min-h-full flex-col",children:[e.jsxs("div",{className:"flex items-center gap-3 px-4 pt-4",children:[e.jsxs("button",{className:"btn-ghost px-3 py-1.5 text-sm",onClick:n,children:["← ",r.id]}),e.jsxs("div",{className:"min-w-0",children:[e.jsx("div",{className:"truncate text-sm font-semibold",children:r.title}),e.jsxs("div",{className:"text-xs text-neutral-500",children:[r.chapter," · ",r.minutes," dk"]})]})]}),e.jsx("div",{className:"flex gap-1 px-4 pt-3",children:J.map((h,g)=>e.jsx("div",{className:"h-1 flex-1 rounded-full "+(g<=i?"bg-accent":"bg-surface-3")},g))}),e.jsxs("div",{ref:me,className:"flex-1 space-y-4 px-4 py-5",children:[e.jsx("h2",{className:"anim-fade text-xl font-bold",children:A.title}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("button",{onClick:()=>t?Ke():ta(i),className:t?"btn-ghost":"btn-accent",disabled:!$.supported,children:t?"⏸ Durdur":"▶ Anlat"}),e.jsxs("button",{onClick:()=>d(h=>!h),className:"btn px-3 py-2 text-sm "+(o?"bg-accent-soft text-accent border border-accent":"bg-surface-2 text-neutral-400 border border-surface-3"),title:"Slaytları otomatik ilerlet",children:["⟳ Oto ",o?"açık":"kapalı"]}),e.jsx("div",{className:"flex overflow-hidden rounded-xl border border-surface-3",children:bn.map(h=>e.jsxs("button",{onClick:()=>m(h),className:"min-h-[44px] px-3.5 py-2.5 text-xs "+(h===k?"bg-accent text-black":"bg-surface-2 text-neutral-400"),children:[h,"×"]},h))})]}),t&&y.n>0&&e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"live-pulse text-xs text-accent",children:"● anlatılıyor"}),e.jsx("div",{className:"h-1 flex-1 overflow-hidden rounded-full bg-surface-3",children:e.jsx("div",{className:"h-full rounded-full bg-accent transition-all duration-300",style:{width:`${y.i/y.n*100}%`}})})]}),!$.supported&&e.jsx("p",{className:"text-xs text-neutral-500",children:"Bu tarayıcı sesli anlatımı desteklemiyor."}),A.bullets&&e.jsx("ul",{className:"space-y-2",children:A.bullets.map((h,g)=>V(g)?e.jsxs("li",{"data-active":j(g),className:"reveal-in flex gap-2 rounded-lg px-2 py-1 text-[15px] leading-relaxed transition-all duration-300 "+(j(g)?"bg-accent-soft ring-1 ring-accent/40":t?"opacity-40":""),children:[e.jsx("span",{className:"mt-1 "+(j(g)?"text-accent":"text-accent/70"),children:j(g)?"▶":"•"}),e.jsx("span",{children:h})]},g):null)}),A.visuals&&V(X)&&e.jsx("div",{"data-active":j(X),className:ae(j(X))+(j(X)?" rounded-xl ring-1 ring-accent/30 -mx-1 px-1 py-1":""),children:e.jsx(un,{items:A.visuals})}),A.table&&V(be)&&e.jsx("div",{"data-active":j(be),className:ae(j(be)),children:e.jsx(fn,{table:A.table})}),A.rangeMatrix&&V(ye)&&e.jsx("div",{"data-active":j(ye),className:ae(j(ye)),children:e.jsx(mn,{})}),A.ruleBox&&V(ee)&&e.jsxs("div",{"data-active":j(ee),className:ae(j(ee))+" rounded-xl border-l-4 border-accent bg-accent-soft px-4 py-3 text-[15px] font-medium leading-relaxed"+(j(ee)?" ring-1 ring-accent/50":""),children:["📌 ",A.ruleBox]})]}),e.jsxs("div",{className:"flex items-center justify-between gap-3 px-4 pb-4",children:[e.jsx("button",{className:"btn-ghost",onClick:()=>Se(i-1),disabled:i===0,children:"← Önceki"}),e.jsxs("span",{className:"text-xs text-neutral-500",children:[i+1," / ",J.length]}),la?e.jsx("button",{className:"btn-accent",onClick:n,children:"Bitir ✓"}):e.jsx("button",{className:"btn-accent",onClick:()=>Se(i+1),children:"Sonraki →"})]})]})}function fn({table:a}){const n=c.useMemo(()=>w(a.section,a.sub),[a.section,a.sub]);return e.jsxs("div",{className:"space-y-2",children:[n?e.jsx(en,{table:n}):e.jsx("p",{className:"text-sm text-neutral-500",children:"Tablo yüklenemedi."}),a.caption&&e.jsx("p",{className:"text-xs italic text-neutral-500",children:a.caption})]})}function hn({onDone:a}){const n=c.useMemo(()=>Ne(),[]),[r,i]=c.useState(0),[l,t]=c.useState(!1),[s,o]=c.useState(0);if(n.length===0)return e.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-4xl",children:"👍"}),e.jsx("p",{className:"text-neutral-300",children:"Bugün tekrar zamanı gelen konu yok."}),e.jsx("button",{onClick:a,className:"btn-accent px-4 py-2",children:"İlerlemeye dön"})]});if(r>=n.length)return e.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-4xl",children:"🎉"}),e.jsxs("p",{className:"text-neutral-200",children:["Bugünlük tekrar bitti — ",s," konu."]}),e.jsx("button",{onClick:a,className:"btn-accent px-4 py-2",children:"İlerlemeye dön"})]});const d=n[r];function k(m){Pa(d.id,m),ue(),o(u=>u+1),t(!1),i(u=>u+1)}return e.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:a,className:"text-neutral-400",children:"← İlerleme"}),e.jsxs("span",{className:"text-neutral-500",children:[r+1," / ",n.length]})]}),e.jsx("div",{className:"h-1 overflow-hidden rounded bg-surface-2",children:e.jsx("div",{className:"h-full bg-accent transition-all",style:{width:`${r/n.length*100}%`}})}),e.jsxs("div",{className:"card min-h-[180px] p-5",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:d.kavram}),e.jsx("p",{className:"mt-2 text-lg leading-relaxed text-neutral-100",children:d.soru_ozeti}),l&&e.jsxs("div",{className:"mt-4 border-t border-surface-3 pt-3",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"Not / doğru"}),e.jsxs("p",{className:"mt-1 text-sm text-neutral-300",children:[d.not||"—",e.jsxs("span",{className:"ml-2 text-neutral-500",children:["(son sonuç: ",d.sonuc,")"]})]})]})]}),l?e.jsxs("div",{className:"grid grid-cols-3 gap-2",children:[e.jsx("button",{onClick:()=>k("wrong"),className:"btn-ghost py-3 text-red-300",children:"✗ Bilemedim"}),e.jsx("button",{onClick:()=>k("half"),className:"btn-ghost py-3 text-accent",children:"◐ Yarım"}),e.jsx("button",{onClick:()=>k("correct"),className:"btn-ghost py-3 text-emerald-300",children:"✓ Bildim"})]}):e.jsx("button",{onClick:()=>t(!0),className:"btn-accent py-3 text-base",children:"Göster"})]})}const vn=[{n:11,short:"Şişmiş Pot · Turn · River"},{n:12,short:"ICM & Final Table"},{n:13,short:"Multiway Pot"},{n:14,short:"40–70bb Köprü"},{n:15,short:"PLO Turnuva Katmanı"},{n:16,short:"Zihinsel Omurga"},{n:17,short:"WSOP Online ME Day 2 ★"}];function gn(a){const n=a.split(`
`),r=[];let i=[];const l=()=>{const s=i.join(" ").trim();s&&r.push({k:"p",text:s}),i=[]};let t=0;for(;t<n.length;){const s=n[t].trim();if(s===""||s==="---")l(),t++;else if(s.startsWith("### "))l(),r.push({k:"h3",text:s.slice(4).trim()}),t++;else if(s.startsWith("|")){l();const o=[];for(;t<n.length&&n[t].trim().startsWith("|");)o.push(n[t++].trim());const d=k=>k.replace(/^\|/,"").replace(/\|$/,"").split("|").map(m=>S(m));r.push({k:"table",headers:d(o[0]),rows:o.slice(2).map(d)})}else if(s.startsWith("> "))l(),r.push({k:"quote",text:s.slice(2).trim()}),t++;else if(/^([-*]|\d+\.)\s/.test(s)){l();const o=[];for(;t<n.length&&/^([-*]|\d+\.)\s/.test(n[t].trim());)o.push(n[t++].trim().replace(/^([-*]|\d+\.)\s/,""));r.push({k:"list",items:o})}else i.push(s),t++}return l(),r}function ie({text:a}){const n=a.split(/(\*\*[^*]+?\*\*|\*[^*]+?\*)/g).filter(Boolean);return e.jsx(e.Fragment,{children:n.map((r,i)=>r.startsWith("**")&&r.endsWith("**")?e.jsx("b",{children:r.slice(2,-2)},i):r.startsWith("*")&&r.endsWith("*")?e.jsx("i",{className:"text-neutral-400",children:r.slice(1,-1)},i):e.jsx("span",{children:r},i))})}function xn({title:a,onDone:n}){const r=c.useMemo(()=>gn(D(a)),[a]);return e.jsxs("div",{className:"flex flex-col gap-3 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:n,className:"text-neutral-400",children:"← Bölümler"}),e.jsx("span",{className:"font-semibold text-neutral-100",children:"📖 Kitap"}),e.jsx("span",{className:"w-16"})]}),e.jsx("h1",{className:"text-base font-semibold leading-snug text-neutral-100",children:a}),r.map((i,l)=>i.k==="h3"?e.jsx("h2",{className:"mt-2 text-sm font-semibold text-accent",children:i.text},l):i.k==="quote"?e.jsx("blockquote",{className:"border-l-2 border-accent bg-accent-soft px-3 py-2 text-[13px] font-medium leading-relaxed text-accent",children:e.jsx(ie,{text:i.text})},l):i.k==="list"?e.jsx("ul",{className:"ml-1 space-y-1",children:i.items.map((t,s)=>e.jsxs("li",{className:"flex gap-2 text-[13px] leading-snug text-neutral-200",children:[e.jsx("span",{className:"shrink-0 text-accent",children:"•"}),e.jsx("span",{children:e.jsx(ie,{text:t})})]},s))},l):i.k==="table"?e.jsx("div",{className:"overflow-x-auto",children:e.jsxs("table",{className:"w-full border-collapse text-[12px]",children:[e.jsx("thead",{children:e.jsx("tr",{children:i.headers.map((t,s)=>e.jsx("th",{className:"border border-surface-3 bg-surface-2 px-2 py-1 text-left font-semibold text-neutral-300",children:t},s))})}),e.jsx("tbody",{children:i.rows.map((t,s)=>e.jsx("tr",{children:t.map((o,d)=>e.jsx("td",{className:"border border-surface-3 px-2 py-1 align-top text-neutral-200",children:e.jsx(ie,{text:o})},d))},s))})]})},l):e.jsx("p",{className:"text-[13px] leading-relaxed text-neutral-300",children:e.jsx(ie,{text:i.text})},l))]})}const ra="leakcard:date";function Bn(){var n;const a=((n=Ge()[0])==null?void 0:n.kavram)||"";return/icm|cover/i.test(a)?"cover":"pot"}function ia(){return new Date().toISOString().slice(0,10)}function zn(){return R(ra,"")===ia()}function Ie(){const a=Math.random()<.45,n=4+Math.floor(Math.random()*60),r=8+Math.floor(Math.random()*90),i=n/(n+r),l=a||i>=.4;return{potBb:n,behindBb:r,threeBet:a,bloated:l}}function An(){const[a,n]=c.useState(zn()?"hidden":"card"),[r]=c.useState(()=>Bn()),i=c.useRef(null);if(c.useEffect(()=>{var t,s;a!=="hidden"&&((s=(t=i.current)==null?void 0:t.querySelector("button"))==null||s.focus())},[a]),a==="hidden")return null;const l=()=>{C(ra,ia()),ue(),n("hidden")};return e.jsx("div",{ref:i,role:"dialog","aria-modal":"true","aria-label":"Günün kartı",onKeyDown:t=>{var k;if(t.key!=="Tab")return;const s=(k=i.current)==null?void 0:k.querySelectorAll("button, input, textarea, a[href]");if(!s||s.length===0)return;const o=s[0],d=s[s.length-1];t.shiftKey&&document.activeElement===o?(t.preventDefault(),d.focus()):!t.shiftKey&&document.activeElement===d&&(t.preventDefault(),o.focus())},className:"fixed inset-0 z-50 flex flex-col bg-surface-0/95 backdrop-blur",children:e.jsx("div",{className:"mx-auto flex h-full w-full max-w-md flex-col",children:a==="card"?r==="cover"?e.jsx(Nn,{onDrill:()=>n("drill"),onDone:l}):e.jsx(jn,{onDrill:()=>n("drill"),onDone:l}):r==="cover"?e.jsx(Tn,{onDone:l}):e.jsx(Kn,{onDone:l})})})}function jn({onDrill:a,onDone:n}){return e.jsxs("div",{className:"flex flex-1 flex-col justify-center gap-6 p-6",children:[e.jsx("div",{className:"text-center text-xs uppercase tracking-[0.2em] text-accent",children:"Günün kartı"}),e.jsx("div",{className:"card border-l-4 border-accent p-6",children:e.jsxs("p",{className:"text-lg leading-relaxed",children:[e.jsx("b",{className:"text-accent",children:"EĞER"})," pot şişmiş (3-bet+ pot ya da stack'imin ~%40'ı ortada)"," ",e.jsx("b",{className:"text-accent",children:"VE"})," elimde tek per var,",e.jsx("br",{}),e.jsx("b",{className:"text-accent",children:"O ZAMAN"})," içimden ",e.jsx("b",{children:'"bluff-catcher"'})," derim: check/call ya da fold —"," ",e.jsx("b",{children:"asla value raise."})]})}),e.jsx("p",{className:"text-center text-[11px] text-neutral-600",children:"Kitabın tanımı: şişmiş = 3-bet+ pot. “~%40 stack ortada” pratik bir sezgi (kitap dışı)."}),e.jsx("p",{className:"text-center text-sm text-neutral-500",children:"Yüksek sesle bir kez oku. Masada bu cümle otomatik ateşlenecek."}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("button",{onClick:n,className:"btn-accent w-full py-3 text-base",children:"Prova ettim ✓"}),e.jsx("button",{onClick:a,className:"btn-ghost w-full py-3",children:"⏱ 90sn cue drill →"})]})]})}function Nn({onDrill:a,onDone:n}){return e.jsxs("div",{className:"flex flex-1 flex-col justify-center gap-6 p-6",children:[e.jsx("div",{className:"text-center text-xs uppercase tracking-[0.2em] text-accent",children:"Günün kartı"}),e.jsx("div",{className:"card border-l-4 border-accent p-6",children:e.jsxs("p",{className:"text-lg leading-relaxed",children:[e.jsx("b",{className:"text-accent",children:"EĞER"})," jam'e fold basmak üzereysem,",e.jsx("br",{}),e.jsx("b",{className:"text-accent",children:"O ZAMAN"})," önce sınıflarım: ",e.jsx("b",{children:"seni cover eden mi, senin cover ettiğin mi?"})," Cover edilmiyorsam → ",e.jsx("b",{children:"call çok daha geniş."})]})}),e.jsx("p",{className:"text-center text-[11px] text-neutral-600",children:"Kitap (B12): cover'sız aralık cover'lıdan asla sıkı olamaz — kaybetsen de bust olmazsın."}),e.jsx("p",{className:"text-center text-sm text-neutral-500",children:"Yüksek sesle bir kez oku. Masada bu cümle otomatik ateşlenecek."}),e.jsxs("div",{className:"flex flex-col gap-2",children:[e.jsx("button",{onClick:n,className:"btn-accent w-full py-3 text-base",children:"Prova ettim ✓"}),e.jsx("button",{onClick:a,className:"btn-ghost w-full py-3",children:"⏱ 90sn cue drill →"})]})]})}const O=12;function Fe(){const a=12+Math.floor(Math.random()*60),n=3+Math.floor(Math.random()*40),r=Math.random()<.5?a+n:Math.max(3,a-n);return{heroBb:a,jammerBb:r,covered:r>=a}}function Tn({onDone:a}){const[n,r]=c.useState(0),[i,l]=c.useState(()=>Fe()),[t,s]=c.useState(null),[o,d]=c.useState(0),k=t===i.covered,m=n>=O;function u(b){s(b),b===i.covered&&d(p=>p+1)}function f(){if(n+1>=O){r(O);return}r(b=>b+1),l(Fe()),s(null)}return m?e.jsxs("div",{className:"flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-5xl",children:"🎯"}),e.jsxs("p",{className:"text-lg text-neutral-100",children:[o,"/",O," doğru"]}),e.jsx("p",{className:"text-sm text-neutral-500",children:"Jam'e fold basmadan önce: cover ediliyor muyum? Hayır → call çok daha geniş."}),e.jsx("button",{onClick:a,className:"btn-accent px-6 py-3",children:"Bitir ✓"})]}):e.jsxs("div",{className:"flex flex-1 flex-col gap-5 p-6",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("span",{className:"text-neutral-500",children:"Cue drill"}),e.jsxs("span",{className:"text-neutral-400",children:[n+1," / ",O]})]}),e.jsxs("div",{className:"card p-5",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"rounded-full bg-accent-soft px-3 py-1 text-sm font-semibold text-accent",children:["Sende ",i.heroBb,"bb"]}),e.jsxs("span",{className:"text-sm text-neutral-400",children:["jam atan ",i.jammerBb,"bb"]})]}),e.jsx("div",{className:"mt-3 text-sm text-neutral-400",children:"Bubble. Jam sana geldi."})]}),t===null?e.jsxs("div",{children:[e.jsx("div",{className:"mb-2 text-center text-[15px] font-medium",children:"Sınıfla: bu jam…"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx("button",{onClick:()=>u(!0),className:"btn-ghost py-4 text-base",children:"Beni cover ediyor"}),e.jsx("button",{onClick:()=>u(!1),className:"btn-ghost py-4 text-base",children:"Ben cover ediyorum"})]})]}):e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsx("div",{className:"rounded-xl px-4 py-3 text-sm font-medium "+(k?"bg-emerald-500/15 text-emerald-300":"bg-red-500/15 text-red-300"),children:i.covered?"Cover ediliyorsun — kaybedersen bust. Call sert daralır.":"Cover edilmiyorsun — kaybetsen de bust olmazsın. Call sandığından çok daha geniş."}),e.jsx("button",{onClick:f,className:"btn-accent py-3 text-base",children:n+1>=O?"Bitir":"Sonraki →"})]}),e.jsx("button",{onClick:a,className:"btn-ghost mt-auto w-full py-3",children:"atla"})]})}function Kn({onDone:a}){const[n,r]=c.useState(0),[i,l]=c.useState(()=>Ie()),[t,s]=c.useState("pot"),[o,d]=c.useState(null),[k,m]=c.useState(null),[u,f]=c.useState(0),b=o===i.bloated,p=k===i.bloated,y=b&&p,z=n>=O;function T(P){d(P),s("class")}function L(P){m(P),b&&P===i.bloated&&f(G=>G+1),s("fb")}function B(){if(n+1>=O){r(O);return}r(P=>P+1),l(Ie()),d(null),m(null),s("pot")}return z?e.jsxs("div",{className:"flex flex-1 flex-col items-center justify-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-5xl",children:"🎯"}),e.jsxs("p",{className:"text-lg text-neutral-100",children:[u,"/",O," doğru"]}),e.jsx("p",{className:"text-sm text-neutral-500",children:"Şişmiş potta tek per = bluff-catcher. Bu refleksi masaya götür."}),e.jsx("button",{onClick:a,className:"btn-accent px-6 py-3",children:"Bitir ✓"})]}):e.jsxs("div",{className:"flex flex-1 flex-col gap-5 p-6",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("span",{className:"text-neutral-500",children:"Cue drill"}),e.jsxs("span",{className:"text-neutral-400",children:[n+1," / ",O]})]}),e.jsxs("div",{className:"card p-5",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("span",{className:"rounded-full bg-accent-soft px-3 py-1 text-sm font-semibold text-accent",children:["Pot ",i.potBb,"bb"]}),e.jsxs("span",{className:"text-sm text-neutral-400",children:["arkanda ",i.behindBb,"bb"]})]}),i.threeBet&&e.jsx("div",{className:"mt-2 inline-block rounded-full bg-red-500/15 px-2 py-0.5 text-xs text-red-300",children:"3-bet'li pot"}),e.jsx("div",{className:"mt-3 text-sm text-neutral-400",children:"Elin: tek per (overpair)"})]}),t==="pot"&&e.jsxs("div",{children:[e.jsx("div",{className:"mb-2 text-center text-[15px] font-medium",children:"Pot şişmiş mi?"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx("button",{onClick:()=>T(!0),className:"btn-ghost py-4 text-base",children:"Evet, şişmiş"}),e.jsx("button",{onClick:()=>T(!1),className:"btn-ghost py-4 text-base",children:"Hayır"})]})]}),t==="class"&&e.jsxs("div",{children:[e.jsx("div",{className:"mb-2 text-center text-[15px] font-medium",children:"Tek per'in sınıfı?"}),e.jsxs("div",{className:"grid grid-cols-2 gap-2",children:[e.jsx("button",{onClick:()=>L(!0),className:"btn-ghost py-4 text-base",children:"Bluff-catcher"}),e.jsx("button",{onClick:()=>L(!1),className:"btn-ghost py-4 text-base",children:"Value"})]})]}),t==="fb"&&e.jsxs("div",{className:"flex flex-col gap-3",children:[e.jsxs("div",{className:"rounded-xl px-4 py-3 text-sm font-medium "+(y?"bg-emerald-500/15 text-emerald-300":"bg-red-500/15 text-red-300"),children:[e.jsx("div",{children:i.bloated?"Şişmiş pot → tek per BLUFF-CATCHER.":"Şişmemiş → tek per hâlâ value/showdown."}),!y&&e.jsx("div",{className:"mt-1 font-normal opacity-90",children:b?`Pot okuman doğru, sınıflama yanlış: ${i.bloated?"bluff-catcher":"value/showdown"}.`:p?"Sınıflaman doğru, pot okuması yanlıştı.":"Pot okuması da sınıflama da yanlıştı."})]}),e.jsx("button",{onClick:B,className:"btn-accent py-3 text-base",children:n+1>=O?"Bitir":"Sonraki →"})]}),e.jsx("button",{onClick:a,className:"btn-ghost mt-auto w-full py-3",children:"atla"})]})}const _=[{id:"vaka1",title:"Vaka 1 — A4s river call",setup:"$50K High Roller. Board bölüşmeye açık — chop mekaniği masada. River'da rakip all-in geldi. Elin A4s.",hero:"A4s",board:"",options:["Hero-call","Fold"],correct:1,rule:"Chop'lar jam atmaz: rakip all-in geldiyse bölüşen eli aralığından çıkarmıştır — jam seni geçen eldir. Bir mekaniği görmek yetmez; rakibin hamlesi o mekanikle uyumlu mu diye sor. 📌 Chop varken jam = seni geçmiş el.",selfExplain:"Chop mekaniğini doğru gördün — peki hangi filtreyi atladın?",concept:"kök-hata"},{id:"vaka2",title:"Vaka 2 — KTo top pair",setup:"$10K 6-max. Islak board, top pair (KT) flopladın. OOP'sun, rakip cbet attı. Sıra sende.",hero:"KTo",board:"",options:["Check-raise all-in","Check-call, sonra değerlendir"],correct:1,rule:"Tek per stack-off yakıtı değil. Islak boardda top pair büyük pot başlatıcı değildir; stack'i sen başlatınca seni ödeyen aralık senden iyi. Şişmiş pota giden yol elini bluff-catcher'a çevirir. 📌 Top pair islak boardda: check-call, başlatma.",selfExplain:"Top pair güçlü göründü — pot büyüyünce elinin sınıfı ne oldu?",concept:"kök-hata"},{id:"vaka3",title:"Vaka 3 — AA river jam",setup:"Board 2-4-5, flop+turn value bet (ikisi de doğruydu). River 6 geldi — senden zayıf hiçbir el artık ödemez. Elin AA. Rakip check etti.",hero:"AA",board:"2c 4d 5s ?? 6h",options:["Kalan stack'i jam","Check"],correct:1,rule:"River'da senden zayıf el ödemeyecekse jam value değildir. O river'da 3'lü/kent/set seni geçmiş, tek per pas — value target yok. Kötü river'da overpair: küçük pota check-call, büyük pota check-fold. 📌 Ödeyecek zayıf el yoksa jam yok.",selfExplain:"Flop+turn value doğruydu — river 6'da tam olarak ne değişti?",concept:"kök-hata"},{id:"vaka4",title:"Vaka 4 — Senin elin (dün)",setup:"6-max. BB'de T6s, BTN min-raise, call. Flop A-T-3, BTN 1/3 pot, call (çift 10). Turn 5, check-check. River T → board A-T-3-5-T, sende trip 10 ama kicker 6. Check ettin, BTN thin bet. Sıra sende.",hero:"Th 6h",board:"Ac Ts 3d 5c Td",options:["Check-raise all-in","Check-call — bluff-catcher"],correct:1,rule:"Senden zayıf hiçbir el all-in'i ödemez: her 10 senin 6 kicker'ını geçer, boat'lar zaten önde. Bu runout'ta trip'in bluff-catcher — check-call, blöfleri içeride tut. Check-raise all-in blöfleri fold ettirir, seni yalnız geçen el öder. 📌 Ödeyecek zayıf el yoksa raise yok (cümle 2 = Vaka 2).",selfExplain:"Trip 10 güçlü hissettirdi — o board'da kaç el senin 6 kicker'ını GEÇİYOR, kaçı GERİDE kalıp öder?",concept:"kök-hata",beyondBook:!0}];function Sn({onBack:a}){const[n,r]=c.useState(0),[i,l]=c.useState(null),[t]=c.useState(()=>R("autopsy:done",!1)),s=_[n],o=i!==null,d=n>=_.length;function k(u){if(o||(l(u),t))return;const f=u===s.correct;ue(),We({kavram:s.concept,soru_ozeti:`Otopsi: ${s.title}`,sonuc:f?"correct":"wrong",not:s.rule,severity:"tournament_life"})}function m(){l(null),n+1>=_.length&&!t&&C("autopsy:done",!0),r(u=>u+1)}return d?e.jsxs("div",{className:"flex flex-col items-center gap-4 p-8 text-center",children:[e.jsx("div",{className:"text-5xl",children:"🔬"}),e.jsx("p",{className:"text-neutral-200",children:"Vakalar işlendi. Kök hata hep aynıydı."}),e.jsx("p",{className:"text-sm text-neutral-500",children:"Tek per'in şişmiş/multiway potta yanlış sınıflandırılması. Masaya bu refleksi götür."}),e.jsx("button",{onClick:a,className:"btn-accent px-6 py-3",children:"← Derse dön"})]}):e.jsxs("div",{className:"flex min-h-full flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:a,className:"text-neutral-400",children:"← Ders"}),e.jsxs("span",{className:"text-neutral-500",children:[n+1," / ",_.length]})]}),t&&e.jsx("div",{className:"rounded-lg bg-surface-2 px-3 py-2 text-xs text-neutral-400",children:"Tekrar oynatım — puanlanmaz; kendine açıklamaya odaklan."}),e.jsxs("div",{className:"flex flex-wrap items-center gap-2",children:[e.jsx("h1",{className:"text-xl font-bold",children:s.title}),s.beyondBook?e.jsx("span",{className:"rounded border border-dashed border-accent/50 bg-accent-soft px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-accent",children:"Kitap dışı · senin elin"}):e.jsx("span",{className:"rounded bg-emerald-500/15 px-1.5 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-emerald-300",children:"Kitaptan · Bölüm 7"})]}),e.jsxs("div",{className:"card p-4",children:[e.jsx("div",{className:"flex items-center justify-between gap-3",children:e.jsx(F,{spec:s.hero,size:"md",label:"Elin"})}),s.board&&e.jsx("div",{className:"mt-3",children:e.jsx(F,{spec:s.board,size:"sm",label:"Board",texture:!0})}),e.jsx("p",{className:"mt-3 text-[15px] leading-relaxed text-neutral-200",children:s.setup})]}),o?e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"rounded-xl px-4 py-3 text-sm font-medium "+(i===s.correct?"bg-emerald-500/15 text-emerald-300":"bg-red-500/15 text-red-300"),children:[i===s.correct?"✓ Doğru — ":"✗ ","Doğru hat: ",e.jsx("b",{children:s.options[s.correct]})]}),e.jsx("div",{className:"rounded-xl border-l-4 border-accent bg-accent-soft px-4 py-3 text-sm leading-relaxed",children:s.rule}),e.jsxs("div",{className:"card p-3",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"Kendine açıkla"}),e.jsx("p",{className:"mt-1 text-sm text-neutral-300",children:s.selfExplain}),e.jsx("textarea",{rows:2,placeholder:"Sesli ya da yazılı — hangi ipucunu kaçırdın?",className:"mt-2 w-full resize-none rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"})]}),e.jsx(On,{hand:s},s.id),e.jsx("button",{onClick:m,className:"btn-accent py-3 text-base",children:n+1>=_.length?"Bitir":"Sonraki vaka →"})]}):e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"text-center text-sm text-neutral-500",children:"Önce SEN karar ver:"}),e.jsx("div",{className:"grid grid-cols-1 gap-2",children:s.options.map((u,f)=>e.jsx("button",{onClick:()=>k(f),className:"btn-ghost py-3 text-[15px]",children:u},f))})]})]})}function wn(a){return a<1?0:a<=4?1:a<=8?2:3}function On({hand:a}){const[n,r]=c.useState(""),[i,l]=c.useState(""),[t,s]=c.useState(()=>{const m=R("spr-kalibrasyon",[]).find(u=>u.id===a.id);return m?m.spr:null}),o=c.useMemo(()=>w("Bölüm 11","11.0"),[]);function d(){const m=Number(n),u=Number(i);if(!isFinite(m)||m<=0||!isFinite(u)||u<0)return;const f=Math.round(u/m*10)/10;s(f);const b=R("spr-kalibrasyon",[]).filter(p=>p.id!==a.id);C("spr-kalibrasyon",[...b,{id:a.id,pot:m,stack:u,spr:f}]),We({kavram:"spr-kalibrasyon",soru_ozeti:`SPR biç: ${a.title}`,sonuc:"correct",not:`flop pot ${m}bb, kalan stack ${u}bb → SPR ${f}`})}const k=t!==null&&o?o.rows[wn(t)]:null;return e.jsxs("div",{className:"card p-3",children:[e.jsx("div",{className:"text-xs uppercase tracking-wide text-neutral-500",children:"SPR biç (B11.0 · isteğe bağlı)"}),e.jsx("p",{className:"mt-1 text-xs text-neutral-500",children:"Hafızandan gir: floptaki pot ve arkanda kalan stack (bb). Hatırlamıyorsan boş bırak — sayı uydurma."}),e.jsxs("div",{className:"mt-2 flex items-center gap-2",children:[e.jsx("input",{value:n,onChange:m=>r(m.target.value),inputMode:"decimal",placeholder:"flop pot (bb)",className:"w-full min-w-0 rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("input",{value:i,onChange:m=>l(m.target.value),inputMode:"decimal",placeholder:"kalan stack (bb)",className:"w-full min-w-0 rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("button",{onClick:d,className:"btn-ghost shrink-0 px-3 py-2 text-sm",children:"Hesapla"})]}),t!==null&&e.jsxs("div",{className:"mt-3 text-sm",children:[e.jsxs("div",{className:"font-semibold text-accent",children:["SPR ≈ ",t]}),k?e.jsxs("div",{className:"mt-1 rounded-lg bg-surface-2 px-3 py-2 text-xs leading-relaxed text-neutral-300",children:[e.jsx("b",{children:k[0]})," · ",k[1]," → ",k[2]]}):e.jsx("p",{className:"mt-1 text-xs text-neutral-500",children:"Bant tablosu yüklenemedi (B11.0)."})]})]})}const He="journal",Cn=[{v:.6,label:"%60"},{v:.8,label:"%80"},{v:.95,label:"%95"}];function Pn({onDone:a}){const[n,r]=c.useState(()=>R(He,[])),[i,l]=c.useState(""),[t,s]=c.useState(""),[o,d]=c.useState(""),[k,m]=c.useState(.8),[u,f]=c.useState(null),b=n.filter(y=>y.day===x(-1)).length;function p(){if(!i.trim()||!t.trim()){f({ok:!1,text:"El ve Aksiyon zorunlu — ikisini de doldur."});return}const y=[{day:x(0),el:i,aksiyon:t,gerekce:o,guven:k},...n];r(y),C(He,y),ue(),l(""),s(""),d(""),f({ok:!0,text:"Kaydedildi ✓"})}return e.jsxs("div",{className:"flex flex-col gap-4 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:a,className:"text-neutral-400",children:"← İlerleme"}),e.jsx("span",{className:"font-semibold text-neutral-100",children:"🗒 Karar günlüğü"}),e.jsx("span",{className:"w-12"})]}),_e()&&e.jsx("div",{className:"rounded-xl border border-accent/40 bg-accent-soft px-4 py-2.5 text-sm text-accent",children:"🥊 Cornerman modu açık. Taper: hacmi düşür, yoğunluğu koru. Gece geç çalışma yok — uyku tilt'i büyütür."}),e.jsx("p",{className:"text-sm text-neutral-500",children:"Sonucu bilmeden yaz. İyi karar kötü sonuç = doğru. Ertesi gün süreç puanlanır, sonuç değil."}),b>0&&e.jsxs("a",{href:"#/drill",className:"rounded-xl border border-accent/40 bg-accent-soft px-4 py-2.5 text-sm text-accent",children:["Dün masadan ",b," el getirdin → Drill'de puanla"]}),e.jsxs("div",{className:"card space-y-2 p-4",children:[e.jsx("input",{value:i,onChange:y=>l(y.target.value),placeholder:"El / spot (ör. 42bb CO KQo, HJ açtı)",className:"w-full rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("input",{value:t,onChange:y=>s(y.target.value),placeholder:"Aksiyon (fold / 3-bet 9bb / check-call…)",className:"w-full rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsx("textarea",{value:o,onChange:y=>d(y.target.value),rows:2,placeholder:"Gerekçe (neden?)",className:"w-full resize-none rounded-xl border border-surface-3 bg-surface-1 px-3 py-2 text-sm outline-none focus:border-accent"}),e.jsxs("div",{className:"flex items-center gap-2",children:[e.jsx("span",{className:"text-xs text-neutral-500",children:"Güven:"}),Cn.map(y=>e.jsx("button",{onClick:()=>m(y.v),className:"rounded-full px-2.5 py-1 text-xs "+(k===y.v?"bg-accent text-black font-semibold":"bg-surface-2 text-neutral-400"),children:y.label},y.v)),e.jsx("button",{onClick:p,className:"btn-accent ml-auto px-4 py-2 text-sm",children:"Kaydet"})]}),u&&e.jsx("div",{className:"text-xs "+(u.ok?"text-emerald-400":"text-red-400"),children:u.text})]}),n.length===0?e.jsx("p",{className:"text-center text-sm text-neutral-600",children:"Henüz kayıt yok."}):e.jsx("div",{className:"space-y-2",children:n.map((y,z)=>e.jsxs("div",{className:"card p-3 text-sm",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsx("span",{className:"font-semibold text-neutral-100",children:y.el}),e.jsx("span",{className:"text-xs text-neutral-500",children:y.day})]}),e.jsxs("div",{className:"text-accent",children:[y.aksiyon," · %",Math.round(y.guven*100)]}),y.gerekce&&e.jsx("div",{className:"mt-1 text-neutral-400",children:y.gerekce})]},z))})]})}const En=c.lazy(()=>M(()=>import("./Quiz-B98rUzXd.js"),__vite__mapDeps([0,1,2])).then(a=>({default:a.Quiz}))),Rn=c.lazy(()=>M(()=>import("./Drill-Bq6EstFB.js"),__vite__mapDeps([3,1,4])).then(a=>({default:a.Drill}))),Mn=c.lazy(()=>M(()=>import("./Simulator-CPYjrfIj.js"),__vite__mapDeps([5,1,4])).then(a=>({default:a.Simulator}))),Ln=c.lazy(()=>M(()=>import("./Progress-BiIBh5r8.js"),__vite__mapDeps([6,1])).then(a=>({default:a.Progress}))),Dn=c.lazy(()=>M(()=>import("./QuickReference-B_OK8CQu.js"),__vite__mapDeps([7,1])).then(a=>({default:a.QuickReference}))),Jn=c.lazy(()=>M(()=>import("./Sentences-ByTAk8mf.js"),__vite__mapDeps([8,1])).then(a=>({default:a.Sentences}))),Qn=c.lazy(()=>M(()=>import("./RangeAtlas-C_V4X2mo.js"),__vite__mapDeps([9,1,2])).then(a=>({default:a.RangeAtlas}))),In=c.lazy(()=>M(()=>import("./EquityIntuition-hSgOIQnY.js"),__vite__mapDeps([10,1])).then(a=>({default:a.EquityIntuition}))),Fn=c.lazy(()=>M(()=>import("./BetTypes-DWkDXoZ5.js"),__vite__mapDeps([11,1])).then(a=>({default:a.BetTypes}))),Hn=c.lazy(()=>M(()=>import("./QuestionBank-DQbrCQrD.js"),__vite__mapDeps([12,1])).then(a=>({default:a.QuestionBank}))),qn=c.lazy(()=>M(()=>import("./IcmCard-D0BkWK5B.js"),__vite__mapDeps([13,1])).then(a=>({default:a.IcmCard})));function Yn(){const[a,n]=c.useState(()=>window.location.hash);return c.useEffect(()=>{const r=()=>n(window.location.hash);return window.addEventListener("hashchange",r),()=>window.removeEventListener("hashchange",r)},[]),a}function v(a){window.location.hash=a}const Vn=[{id:"ders",label:"Ders",icon:"📚"},{id:"quiz",label:"Quiz",icon:"🎯"},{id:"drill",label:"Drill",icon:"🃏"},{id:"ilerleme",label:"İlerleme",icon:"📊"},{id:"referans",label:"Referans",icon:"⚡"}];function $n(){return e.jsx("div",{className:"flex h-full items-center justify-center text-sm text-neutral-500",children:"Yükleniyor…"})}function _n(){const n=Yn().replace(/^#\/?/,"").split("/").filter(Boolean),i=new Set(["ders","quiz","drill","ilerleme","referans"]).has(n[0])?n[0]:"ders",l=n[1],t=c.useRef(null),[s,o]=c.useState(!1);return c.useEffect(()=>{var d;(d=t.current)==null||d.scrollTo(0,0)},[n[0],n[1]]),c.useEffect(()=>{const d=()=>o(!0);return window.addEventListener("ept:storage-fail",d,{once:!0}),()=>window.removeEventListener("ept:storage-fail",d)},[]),e.jsxs("div",{className:"mx-auto flex h-[100dvh] max-w-md flex-col bg-surface-0 pt-[env(safe-area-inset-top)]",children:[e.jsx(An,{}),s&&e.jsxs("div",{className:"flex items-center justify-between gap-3 bg-red-900/80 px-4 py-2 text-[13px] text-red-100",children:[e.jsx("span",{children:"Kayıt yapılamıyor — depolama dolu/kısıtlı"}),e.jsx("button",{"aria-label":"Kapat",className:"px-1 font-semibold",onClick:()=>o(!1),children:"✕"})]}),e.jsx("main",{ref:t,className:"flex-1 overflow-y-auto",children:e.jsxs(c.Suspense,{fallback:e.jsx($n,{}),children:[i==="ders"&&(l==="otopsi"?e.jsx(Sn,{onBack:()=>v("#/ders")}):l?e.jsx(pn,{moduleId:l,onBack:()=>v("#/ders")}):e.jsx(Da,{onOpen:d=>v("#/ders/"+d)})),i==="quiz"&&e.jsx(En,{}),i==="drill"&&e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"flex gap-2 px-4 pt-4",children:[e.jsx("button",{onClick:()=>v("#/drill"),className:"btn px-3 py-2 text-sm "+(n[1]!=="masa"?"bg-accent-soft text-accent border border-accent":"bg-surface-2 text-neutral-400 border border-surface-3"),children:"🃏 Soru drill"}),e.jsx("button",{onClick:()=>v("#/drill/masa"),className:"btn px-3 py-2 text-sm "+(n[1]==="masa"?"bg-accent-soft text-accent border border-accent":"bg-surface-2 text-neutral-400 border border-surface-3"),children:"🎲 Masa (el sim)"})]}),n[1]==="masa"?e.jsx(Mn,{}):e.jsx(Rn,{})]}),i==="ilerleme"&&(n[1]==="tekrar"?e.jsx(hn,{onDone:()=>v("#/ilerleme")}):n[1]==="gunluk"?e.jsx(Pn,{onDone:()=>v("#/ilerleme")}):e.jsx(Ln,{onReview:()=>v("#/ilerleme/tekrar"),onJournal:()=>v("#/ilerleme/gunluk")})),i==="referans"&&(n[1]==="cumleler"?e.jsx(Jn,{onDone:()=>v("#/referans")}):n[1]==="araliklar"?e.jsx(Qn,{onDone:()=>v("#/referans")}):n[1]==="equity"?e.jsx(In,{onDone:()=>v("#/referans")}):n[1]==="bahis"?e.jsx(Fn,{onDone:()=>v("#/referans")}):n[1]==="sorubankasi"?e.jsx(Hn,{onDone:()=>v("#/referans")}):n[1]==="icmkart"?e.jsx(qn,{onDone:()=>v("#/referans")}):n[1]==="bolum"&&n[2]?e.jsx(xn,{title:"Bölüm "+n[2],onDone:()=>v("#/referans/bolum")}):n[1]==="bolum"?e.jsxs("div",{className:"flex flex-col gap-3 p-4",children:[e.jsxs("div",{className:"flex items-center justify-between text-sm",children:[e.jsx("button",{onClick:()=>v("#/referans"),className:"text-neutral-400",children:"← Referans"}),e.jsx("span",{className:"font-semibold text-neutral-100",children:"📖 Yeni Bölümler (v5)"}),e.jsx("span",{className:"w-16"})]}),e.jsx("p",{className:"text-[13px] leading-relaxed text-neutral-400",children:"Turnuva-kazanma bölümleri — doğrudan kitaptan. Molada telefondan tabloya bak."}),vn.map(d=>e.jsxs("button",{onClick:()=>v("#/referans/bolum/"+d.n),className:"card flex items-center justify-between p-3 text-left",children:[e.jsxs("span",{className:"text-[14px] text-neutral-100",children:[e.jsxs("span",{className:"font-mono text-neutral-500",children:["B",d.n]})," · ",d.short]}),e.jsx("span",{className:"text-accent",children:"→"})]},d.n))]}):e.jsxs(e.Fragment,{children:[e.jsxs("div",{className:"grid grid-cols-2 gap-2 p-4 pb-0",children:[e.jsx("button",{onClick:()=>v("#/referans/araliklar"),className:"btn-accent py-2.5",children:"🗂️ Aralık Rehberi →"}),e.jsx("button",{onClick:()=>v("#/referans/cumleler"),className:"btn-ghost py-2.5",children:"🧠 15 Cümle ezber →"}),e.jsx("button",{onClick:()=>v("#/referans/equity"),className:"btn-ghost col-span-2 py-2.5",children:"📐 Equity Sezgisi (bonus · kitap dışı) →"}),e.jsx("button",{onClick:()=>v("#/referans/bahis"),className:"btn-ghost col-span-2 py-2.5",children:"🎯 Bahis Tipleri (value/bluff/thin/overbet) →"}),e.jsx("button",{onClick:()=>v("#/referans/sorubankasi"),className:"btn-ghost col-span-2 py-2.5",children:"📝 Soru Bankası (Bölüm 10 · 37 soru) →"}),e.jsx("button",{onClick:()=>v("#/referans/icmkart"),className:"btn-ghost col-span-2 py-2.5",children:"🧮 ICM Kartım (ladder + <15bb jam · Bölüm 12) →"}),e.jsx("button",{onClick:()=>v("#/referans/bolum"),className:"btn-accent col-span-2 py-2.5",children:"📖 Yeni Bölümler v5 (ICM · River · Multiway…) →"})]}),e.jsx(Dn,{})]}))]})}),e.jsx("nav",{"aria-label":"Ana sekmeler",className:"grid grid-cols-5 border-t border-surface-3 bg-surface-1 pb-[env(safe-area-inset-bottom)]",children:Vn.map(d=>{const k=d.id===i;return e.jsxs("button",{"aria-current":k?"page":void 0,onClick:()=>v("#/"+d.id),className:"flex flex-col items-center gap-0.5 py-2.5 text-xs transition "+(k?"text-accent":"text-neutral-500"),children:[e.jsx("span",{className:"text-lg",children:d.icon}),d.label]},d.id)})})]})}class Un extends qe.Component{constructor(){super(...arguments);Y(this,"state",{hasError:!1})}static getDerivedStateFromError(){return{hasError:!0}}componentDidCatch(r){console.error("EPT ErrorBoundary:",r)}async resetData(){const r=Object.keys(localStorage).filter(l=>l.startsWith("ept:")),i=Object.fromEntries(r.map(l=>[l,localStorage.getItem(l)]));try{await navigator.clipboard.writeText(JSON.stringify(i,null,2))}catch{}r.forEach(l=>localStorage.removeItem(l)),location.reload()}render(){return this.state.hasError?e.jsxs("div",{className:"mx-auto flex h-[100dvh] max-w-md flex-col items-center justify-center gap-4 bg-surface-0 p-6 text-center",children:[e.jsx("p",{className:"text-lg font-semibold text-neutral-100",children:"Bir şeyler ters gitti."}),e.jsx("button",{className:"btn-accent",onClick:()=>location.reload(),children:"Yeniden yükle"}),e.jsx("button",{className:"btn-ghost text-sm",onClick:()=>this.resetData(),children:"Verileri sıfırla (önce JSON kopyala)"})]}):this.props.children}}ge.createRoot(document.getElementById("root")).render(e.jsx(qe.StrictMode,{children:e.jsx(Un,{children:e.jsx(_n,{})})}));"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/ept-trainer/sw.js").catch(()=>{})});export{ue as A,Le as B,F as C,rr as D,Be as E,nr as F,ir as G,dn as H,ja as I,_e as J,jr as K,te as L,Za as M,Xa as N,Xn as O,er as P,or as Q,aa as R,xa as S,en as T,sr as U,yr as V,pr as W,fr as X,dr as Y,We as a,br as b,Ge as c,Ne as d,Ia as e,mr as f,cr as g,ur as h,an as i,e as j,vr as k,R as l,gr as m,xr as n,kr as o,ve as p,Br as q,ar as r,C as s,hr as t,zr as u,Ar as v,Na as w,H as x,tr as y,lr as z};
