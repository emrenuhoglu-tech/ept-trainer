...
// Cold-open pretest: bölüm öğretilmeden ÖNCE bir karar denemesi (productive failure).
// UNGRADED — karne/streak'e YAZILMAZ; hata bedava olmalı ki kaçınma öğrenilmesin.
// Bölümü feedback olarak oynatır: soğuk commit → doğru göster → "Derse başla".

// Modül → cold-open kavramı (yalnız eşleşen modüllerde gösterilir).
  ...
  return (
    <div className="flex min-h-full flex-col justify-center gap-4 p-5">
      ...
      <p className="text-center text-sm text-neutral-500">
        Derse başlamadan önce dene. Yanılman serbest — puan yok. Ders senin cevabın.
      </p>
